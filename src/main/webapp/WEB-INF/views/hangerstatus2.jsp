...
<table class="table table-striped">
  <thead class="bg-primary text-white">
    <tr>
      <th scope="col">Hanger Number</th>
      <th scope="col">Hanger Location</th>
      <th scope="col">From Date Booked</th>
      <th scope="col">To Date Booked</th>
  ...
  <tbody>
    			...
    			<tr>
    				<td>${list2.hangerNumber}</td>
    				<td>${list2.hangerLocation}</td>
    				<td>${list2.fromdate}</td>
    				<td>${list2.todate}</td>
    				<td>${list2.planeNo}</td>
    				<td>${list2.status}</td>
    			</tr>
